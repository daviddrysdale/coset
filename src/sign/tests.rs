...
fn test_sign_noncanonical() {
    ...
    let tests = vec![
        ...
        ("a0", Header::default()),
        // Non-canonical: the map length (of 0) is non-minimally encoded as the 0x00 following 0xb8; it is short enough
        // that it would normally be folded into the type byte (0xa0).
        ("b800", Header::default()),
